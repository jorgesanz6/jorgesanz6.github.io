...
export const projects = [
  {
    ...
    approach: [
      "Pipeline propio de ingesta multi-fuente (series temporales de resultados, estadísticas históricas, incidencias) orquestado por cron, sin intervención manual.",
    ...
    tech: ["Python", "XGBoost / LightGBM / CatBoost", "Supabase", "GitHub Actions"],
    status: "En uso",
    url: null,
  },
  {
