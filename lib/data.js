...
export const stats = [
  { value: "+60%", label: "rendimiento en dashboards clave" },
  { value: "3M€+", label: "facturación gestionada con analítica" },
  { value: "6", label: "certificaciones en 6 meses" },
  { value: "+3", label: "años en Business Intelligence" },
]
