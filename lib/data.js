...
export const experience = [
  {
    ...
    problem: "Los dashboards clave iban lentos y los informes recurrentes se generaban a mano, con el riesgo de error que eso conlleva — la información tardaba en llegar a quien tenía que decidir con ella.",
    approach: "Rediseñé los modelos de datos en SQL, optimicé los dashboards en Power BI, automaticé la generación de los informes recurrentes y migré paneles de IBM Cognos Analytics a Power BI Service.",
    impact: "+60% de rendimiento en los dashboards clave, cero errores del proceso manual, y acceso a informes fiables ampliado a varios departamentos.",
  },
  {
